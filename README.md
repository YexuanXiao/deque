...
Additionally, [the noallocator branch](https://github.com/YexuanXiao/deque/tree/noallocator) provides an allocator-free version to explain the design of the deque and facilitate further modifications. The repository [deque-test](https://github.com/yexuanXiao/deque-test) provides a ported version of the test cases from libc++.
